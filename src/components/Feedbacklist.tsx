...
const FeedbackList: React.FC<{
 ...
 const isHomepage = router.pathname === '/'
  ...
  return (
    <>
      <div className={`mt-[20px] w-[327px]  xl:h-[151px] xl:w-[825px] flex ${!isHomepage && 'items-center justify-center'} `}>
        <div className=" box-border flex h-[200px] w-[327px] items-center justify-center rounded-lg border-0 bg-white md:h-[151px] md:w-[689px]  xl:w-[825px]">
          <div className="flex flex-col md:h-[95px] md:w-[689px] px-[32px] md:flex-row md:justify-between xl:w-[761px]">
            <UpvoteBtn
              isUpvoted={isUpvoted}
              feedbackId={id}
